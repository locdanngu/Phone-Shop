<div style="font-family: Arial, sans-serif; margin: 0 auto; max-width: 600px; padding: 20px;">
    <h2 style="color: #333333;">Chào bạn, {{ $name }}</h2>

    <p style="color: #333333;">Đây là mail liên quan đến đơn liên hệ của bạn ở shop của chúng tôi</p>
    <p style="color: #333333;">Nội dung đơn của bạn là</p>
    ...
    <p style="color: #333333;">Bất cứ câu hỏi nào chỉ cần liên hệ tranvanloc96lhp@gmail.com</p>
