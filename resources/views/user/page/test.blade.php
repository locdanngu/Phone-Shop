<form method="post" action="#" class="shipping_calculator">
    ...
    <section id="calcalute-shipping-wrap" class="shipping-calculator-form collapse">
        ...
        <p class="form-row form-row-wide"><input type="text" id="calc_shipping_state" name="calc_shipping_state"
                placeholder="State / county" value="" class="input-text"> </p>

        <p class="form-row form-row-wide"><input type="text" id="calc_shipping_postcode" name="calc_shipping_postcode"
