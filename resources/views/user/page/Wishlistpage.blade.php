...
@section('title', trans('messages.wishlistbtn'))
                                ...
                                <tbody id="capnhatdanhsachcart">
                                    ...
                                    <tr class="cart_item" data-product-id="{{ $l->idwishlist }}">
                                        ...
                                        <td class="product-price">
                                            <span class="amount">{{ $currencySymbol }} @convertCurrency($l->product->price)</span>
                                        </td>
                                ...
                                <ul class="products">
                                    ...
                                    <li class="product">
                                        <a href="{{ route('product.page', ['nameproduct' => $rd->nameproduct]) }}">
                                            ...
                                            <span class="price"><span class="amount">{{ $currencySymbol }} @convertCurrency($rd->price)</span></span>
                                        </a>
...
$('#deleteproduct').on('click', function(event) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            toastr.success('{{ trans('messages.deleteproductsuc') }}');
