...
@section('title', 'Danh sách đơn đang giao')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Quản lý đơn đang giao</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <form action="{{ route('ordership.search') }}" method="get"
...
<div class="modal fade" id="modal-in4">
    <div class="modal-dialog">
        <form class="modal-content" action="{{ route('order.done') }}" method="post">
            @csrf
            ...
            <div class="modal-footer justify-align-content-end">
                ...
                <button type="submit" class="btn btn-primary">Hoàn thành đơn</button>
            </div>
        </form>
        <!-- /.modal-content -->
    </div>
