                            ...
                            <table cellspacing="0" class="shop_table cart">
                                ...
                                <tbody id="capnhatdanhsachorder">
                                    ...
                                    <tr class="cart_item" data-product-id="{{ $c->idcart_product }}">
                                        ...
                                        <td class="product-price">
                                            <span class="amount"
                                                style="color:red; font-weight:bold">{{ $currencySymbol }} @convertCurrency($c->beforecoupon)</span>
                                        </td>
                                        @else
                                        <td class="product-price">
                                            <span class="amount"
                            ...
                            <table cellspacing="0" class="shop_table cart">
                                ...
                                <tbody id="capnhatdanhsachcoupon">
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        @else
                                        <td class="product-quantity">
                                            <span class="amount">@convertCurrency($couponcart->discount_amount) {{ $currencySymbol }}</span>
                                        </td>
                                        @endif
                                        <td class="product-quantity">
                                            <span class="amount"
                                                style="color:red;font-weight:bold">{{ $currencySymbol }} @convertCurrency($couponcart->max_discount_amount)</span>
                                        </td>
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        @else
                                        <td class="product-quantity">
                                            <span class="amount">@convertCurrency($c->discount_amount) {{ $currencySymbol }}</span>
                                        </td>
                                        @endif
                                        <td class="product-quantity">
                                            <span class="amount"
                                                style="color:red;font-weight:bold">{{ $currencySymbol }} @convertCurrency($c->max_discount_amount)</span>
                                        </td>
                                        <td class="actions" style="display: flex;justify-content:center">
                                            <a href="#" type="button" data-toggle="modal"
                ...
                <tbody>
                    <tr class="cart_item">
                        ...
                        <td class="product-total">
                            <span class="amount font-weight-bold">{{ $currencySymbol }} @convertCurrency($order->totalprice)</span>
                        </td>
                    </tr>
                </tbody>
                <tfoot>
